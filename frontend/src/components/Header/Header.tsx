	...
	return (
		<header className="header">
			...
			<div className="header__user_info">
				<div className={`header__info ${theme}`} onClick={changeEventClick}>
					{
						user.isAuth
						?
						<></>
					...
					<span>{user.isAuth ? user.data.email  : 'Личный кабинет'}</span>
				</div>
				{
					user.isAuth &&
					<div className={`header__exit${theme === 'dark' ? ' header__exit_dark' : ''}`} onClick={exitClickHandler}>
